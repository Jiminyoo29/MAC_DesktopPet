...
알림 감지는 macOS Notification Center의 로컬 기록을 확인하는 방식입니다. macOS가 이 기록 접근을 막으면 pet이 알림에 반응할 수 없습니다.
...
이 방식은 메시지 내용은 읽지 않고, “연결 앱 알림이 왔다”는 신호만 사용합니다. macOS 버전이나 사용자의 시스템 설정에 따라 감지가 제한될 수 있습니다.
